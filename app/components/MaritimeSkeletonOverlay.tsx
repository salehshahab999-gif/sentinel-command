...
export default function MaritimeSkeletonOverlay() {
  ...
  return (
    <>
      ...
      <div className="absolute right-4 top-[calc(35rem-3cm)] z-40 w-[250px] rounded-2xl border border-amber-950/80 bg-[#03090c]/85 p-3 shadow-2xl backdrop-blur-xl md:right-6">
