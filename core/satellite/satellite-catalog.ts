...
export const SATELLITE_LAYERS: SatelliteLayerDefinition[] = [
  ...
  { id: "fires", label: "NASA Fires", description: "Active fire / thermal anomalies", liveReady: true, defaultEnabled: false },
...
export const SATELLITE_WIRE_STATUS: SatelliteWireStatus[] = [
  ...
  { component: "NASA FIRMS", status: "POWERED_OFF", note: "Provider wiring only" },
